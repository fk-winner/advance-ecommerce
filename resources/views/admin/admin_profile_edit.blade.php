            ...
            <div class="row">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Modification du profil de l'administrateur</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <img id="showImage" src="{{ (!empty($editData->profile_photo_path))? url('upload/admin_images/'.$editData->profile_photo_path):url('upload/profile.png') }}"
